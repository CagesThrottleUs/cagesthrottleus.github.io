...
flowchart TB
    subgraph MAINFLOW["🔧 MAIN BRANCH WORKFLOW"]
        ...
        M24 --> M25["npm ci"]
        M25 --> M26["Quality checks<br/>format → lint → test"]
        ...
        M34 --> M35["✅ Live Site<br/>cagesthrottleus.github.io"]
    end
...
flowchart TB
    ...
    PageLoop --> SlicePosts[Slice posts array<br/>start: page-1 × 50<br/>end: min start+50, total]
